  ...
  const textContent = below800 ? (
    <div>
      <Text fontWeight={500} lineHeight={'145.23%'} mt={'10px'}>
        Anyone can create and name any ERC20 token on Mainnetz, including creating fake versions of existing tokens and
          ...
          <div>
            <Hover style={{ marginTop: '10px' }}>
              <Link
                ...
                lineHeight={'145.23%'}
                color={'#2172E5'}
                href={'https://netzexplorer.io/address/' + address}
                target="_blank"
              >
