...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      `https://dex.mainnetz.io/#/` +
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9' ? 'NETZ' : token0Address}/${'NETZ'}`
    )
  } else {
    return (
      `https://dex.mainnetz.io/#/` +
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9' ? 'NETZ' : token0Address}/${
        token1Address === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9' ? 'NETZ' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://dex.mainnetz.io/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://dex.mainnetz.io/#/swap?inputCurrency=${
      token0Address === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9' ? 'NETZ' : token0Address
    }&outputCurrency=${token1Address === '0x41c515fa7d541bcbdefb44f0fe2b1629aec140b9' ? 'NETZ' : token1Address}`
  }
}
...
export const urls = {
  showTransaction: tx => `https://netzexplorer.io/tx/${tx}/`,
  showAddress: address => `https://www.etherscan.io/address/${address}/`,
  showToken: address => `https://www.etherscan.io/token/${address}/`,
  showBlock: block => `https://netzexplorer.io/block/${block}/`
}
